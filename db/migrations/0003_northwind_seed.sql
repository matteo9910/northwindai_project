-- Northwind seed data adapted from pthom/northwind_psql.
-- Guarded so the original seed is loaded only once.
set search_path to erp_core;

do $northwind_seed$
begin
    if exists (select 1 from erp_core.customers limit 1) then
        raise notice 'Northwind seed already present; skipping base seed inserts.';
    else
...
-- Foreign keys from the source dump, guarded for migration replay safety.
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          ...
          and c.conname = 'fk_orders_customers'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          and t.relname = 'orders'
          and c.conname = 'fk_orders_employees'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          and t.relname = 'orders'
          and c.conname = 'fk_orders_shippers'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          ...
          and c.conname = 'fk_order_details_products'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          and t.relname = 'order_details'
          and c.conname = 'fk_order_details_orders'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          ...
          and c.conname = 'fk_products_categories'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          and t.relname = 'products'
          and c.conname = 'fk_products_suppliers'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          ...
          and c.conname = 'fk_territories_region'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          ...
          and c.conname = 'fk_employee_territories_territories'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          and t.relname = 'employee_territories'
          and c.conname = 'fk_employee_territories_employees'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          ...
          and c.conname = 'fk_customer_customer_demo_customer_demographics'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          and t.relname = 'customer_customer_demo'
          and c.conname = 'fk_customer_customer_demo_customers'
    ) then
...
begin
    if not exists (
        ...
        where n.nspname = 'erp_core'
          ...
          and c.conname = 'fk_employees_employees'
    ) then
